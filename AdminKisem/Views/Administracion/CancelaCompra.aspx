<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Master/MenuPrincipal.master" CodeFile="CancelaCompra.aspx.cs" Inherits="Views_Administracion_CancelaCompra" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContenidoPrincipal" runat="server">
    ...
    <br />
    <div style="border-color:Silver; border-width:thin; border-style: solid; overflow:auto; width: 818px; height: 300px; ">
        <asp:UpdatePanel ID="pnlGridView" runat="server">
            <ContentTemplate>
                <asp:Table ID="tblGridView" runat="server" Width="813px" CellPadding="2" Font-Size="Small">
                    <asp:TableRow>
                        <asp:TableCell HorizontalAlign="Center">
                            <asp:GridView ID="gvdCompras" runat="server" AutoGenerateColumns="false" EmptyDataText="No hay información a mostrar."
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Cancelar" Visible="true" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:ImageButton ID="imgBtnCancela" runat="server" ImageUrl="~/Imagenes/Cancela.jpg" OnClick="imgBtnCancela_Click" Width="20" Height="20" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Status Pago" Visible="true" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:Label ID="lblStatusPago" runat="server" Text ='<%#Eval("StatusPago")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                   <asp:TemplateField HeaderText="Status Entrega" Visible="true" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:Label ID="lblStatusEntrega" runat="server" Text ='<%#Eval("StatusEntrega")%>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
